 ...
 *
 */
public class SpeedChart extends de.teunito.android.cyclelife.view.AbstractChart{
	...
	public SpeedChart (Context ctx, long trackId){
		this.mContext = ctx;
	...
	protected void generateData() {
		...
		ArrayList data = mTrackDb.getSpeedForChart(trackId);
		String[] titles = new String[] { "Speed of track "
		...
		setChartSettings(mRenderer, "Speed overview", "time", "km/h", 0, 0,

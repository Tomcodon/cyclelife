 ...
 *
 */
public class CadenceChart extends de.teunito.android.cyclelife.view.AbstractChart{
	...
	public CadenceChart (Context ctx, long trackId){
		this.mContext = ctx;
	...
	protected void generateData() {
		...
		ArrayList data = mTrackDb.getCadenceForChart(trackId);
		String[] titles = new String[] { "Cadence of track "
		...
		setChartSettings(mRenderer, "Cadence overview", "time", "rpm", 0, 0,
